...
# MTSD_FULLY_ANNOTATED_IMAGES_TRAIN_LABELDIR
...
MTSD_FULLY_ANNOTATED_CROPPED_IMAGES_TRAIN_DIR="mtsd_fully_annotated_cropped_images_train/"
MTSD_FULLY_ANNOTATED_CROPPED_IMAGES_VAL_DIR="mtsd_fully_annotated_cropped_images_val/"
MTSD_FULLY_ANNOTATED_CROPPED_IMAGES_TEST_DIR="mtsd_fully_annotated_cropped_images_test/"
...
def main():
    ...
    print("[INFO]: Cropped images saved to \"%s\"" % MTSD_FULLY_ANNOTATED_CROPPED_IMAGES_TRAIN_DIR)
    ...
    print("[INFO]: Cropped images saved to \"%s\"" % MTSD_FULLY_ANNOTATED_CROPPED_IMAGES_VAL_DIR)
    ...
    for label in tqdm(test_label):
        annotation_file = ANNOTATIONS_FOLDER + label + ".json"
        filter_crop_save(image_label=label, annotation=annotation_file, type="train")
    print("[INFO]: Cropped images saved to \"%s\"" % MTSD_FULLY_ANNOTATED_CROPPED_IMAGES_TEST_DIR)
