...
RESNET50V2_WEIGHTS_NOTOP_FILEPATH="../weights/resnet50v2_weights_tf_dim_ordering_tf_kernels_notop.h5"

class ResNetV2(Layer):
    def __init__(self,
        ...
        """
        Instantiates the ResNetV2 Backbone.
    ...
    def _res_blk_stack(self,
        ...
        """
        x = self._res_blk(x=x, filters=filters, strides=(1,1), use_bias=use_bias, conv_shortcut=True,
                          name=name + "_block1")
...
def main():
    """
    Function to test ResNetV2 Backbones
    :return: None
    """
    ...
    resnet50v2_backbone_orig = ResNet50V2(include_top=False, weights="imagenet", input_tensor=None,
